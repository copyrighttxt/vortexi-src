...
def FilterTextAPI():
    ...
    FilteredText = FilterText(Text=RequestedFilterText, ThrowException=False, userId=userId)
    return jsonify({
        "data": {
            "white": FilteredText,
            "black": ""
...
def FilterTextV2API():
    ...
    FilteredText = FilterText(Text=RequestedFilterText, ThrowException=False, userId=userId)
    return jsonify({"success": True, "message": "", "data": {"AgeUnder13": FilteredText, "Age13OrOver": FilteredText}})
